...
export class ReglistService {
  ...
  update(id: any, data: any) {
    ...
    return this.http.put(this.baseUrl + 'user-register/change-paasword/' + id, data);
  }
  ...
  getList(perPage: string | number, page: string | number, searchTerm?: string, sortKey?: string, sortDir?: boolean) {
    ...
    return this.http.get(this.baseUrl+'user-register' + urlPart);
