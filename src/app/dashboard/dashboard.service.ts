...
export class DashboardService {
  ...
  getSanction(){
    return this.http.get(this.baseUrl + 'subgroup/get-sanctioned');
  }
  getCount() {
    return this.http.get(this.baseUrl + 'subgroup/get-counts');
}
getProvinces() {
  return this.http.get(this.baseUrl + 'subgroup/get-provinces');
}
getEthincity(){
  return this.http.get(this.baseUrl + 'subgroup/get-ethnicitycount');
}
...
getdistrict() {
  return this.http.get(this.baseUrl + 'subgroup/get-districts/');
}
getpalika() {
  return this.http.get(this.baseUrl + 'subgroup/get-palikas');
}
